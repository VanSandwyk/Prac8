...
public class Parser {
	...
	public static final int repeat_Sym = 24;
	public static final int until_Sym = 25;
	public static final int do_Sym = 26;
	public static final int halt_Sym = 27;
	public static final int return_Sym = 28;
	public static final int read_Sym = 29;
	public static final int readLine_Sym = 30;
	public static final int write_Sym = 31;
	public static final int writeLine_Sym = 32;
	public static final int barbar_Sym = 33;
	public static final int andand_Sym = 34;
	public static final int plus_Sym = 35;
	public static final int minus_Sym = 36;
	public static final int bang_Sym = 37;
	public static final int new_Sym = 38;
	public static final int sqr_Sym = 39;
	public static final int sqrt_Sym = 40;
	public static final int star_Sym = 41;
	public static final int slash_Sym = 42;
	public static final int percent_Sym = 43;
	public static final int equalequal_Sym = 44;
	public static final int bangequal_Sym = 45;
	public static final int less_Sym = 46;
	public static final int lessequal_Sym = 47;
	public static final int greater_Sym = 48;
	public static final int greaterequal_Sym = 49;
	public static final int equal_Sym = 50;
	public static final int NOT_SYM = 51;
	// pragmas
	public static final int CodeOn_Sym = 52;
	public static final int CodeOff_Sym = 53;
	public static final int DebugOn_Sym = 54;
	public static final int DebugOff_Sym = 55;
	public static final int StackDump_Sym = 56;
	public static final int HeapDump_Sym = 57;
	public static final int TableDump_Sym = 58;

	public static final int maxT = 51;
	public static final int _CodeOn = 52;
	public static final int _CodeOff = 53;
	public static final int _DebugOn = 54;
	public static final int _DebugOff = 55;
	public static final int _StackDump = 56;
	public static final int _HeapDump = 57;
	public static final int _TableDump = 58;
...
/* -------------------------------------------------------------------------- */
	...
	static void WriteList() {
		WriteElement();
		while (WeakSeparator(comma_Sym, 7, 9)) {
			WriteElement();
		}
	}
	...
	static void ReadList() {
		ReadElement();
		while (WeakSeparator(comma_Sym, 10, 9)) {
			ReadElement();
		}
	}
	...
	private static boolean[][] set = {
		{T,T,x,x, x,x,x,x, T,x,T,T, x,x,x,x, x,T,T,T, x,x,T,T, T,x,T,T, T,T,T,T, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x},
		{T,T,x,x, x,x,x,x, T,T,T,T, x,x,x,x, x,T,T,T, x,x,T,T, T,x,T,T, T,T,T,T, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x},
		{x,T,x,x, x,x,x,x, T,x,T,T, x,x,x,x, x,T,T,T, x,x,T,T, T,x,T,T, T,T,T,T, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x},
		{T,T,x,x, x,x,x,x, T,x,T,T, x,x,x,x, x,T,T,T, x,x,T,T, T,x,T,T, T,T,T,T, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x},
		{T,T,x,x, x,x,x,x, T,T,T,T, x,x,x,x, x,T,T,T, x,x,T,T, T,T,T,T, T,T,T,T, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x},
		{x,T,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x},
		{x,x,x,x, x,x,x,x, x,x,T,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x},
		{x,T,T,T, T,x,T,x, x,x,x,x, x,T,T,T, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,T, T,T,T,T, T,x,x,x, x,x,x,x, x,x,x,x, x},
		{T,T,x,x, x,x,T,x, T,x,T,T, x,x,x,x, x,T,T,T, x,x,T,T, T,x,T,T, T,T,T,T, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x},
		{x,x,x,x, x,x,x,T, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x},
		{x,T,x,T, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x},
		{x,T,T,x, T,x,T,x, x,x,x,x, x,T,T,T, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,T, T,T,T,T, T,x,x,x, x,x,x,x, x,x,x,x, x},
		{x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,T,T, T,T,x,x, x},
		{x,T,T,x, T,x,T,x, x,x,x,x, x,T,T,T, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,T,T, T,x,x,x, x,x,x,x, x,x,x,x, x}
...
class Errors {
	...
	public static void SynErr (int line, int col, int n) {
		...
		switch (n) {
			...
			case 39: s = "\"sqr\" expected"; break;
			case 40: s = "\"sqrt\" expected"; break;
			...
			case 52: s = "this symbol not expected in Statement"; break;
