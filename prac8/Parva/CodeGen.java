...
class CodeGen {
  ...
  public static void squareInteger() {
    // Generates code to square integer value on top of evaluation stack
    emit(PVM.sqr);
  } // CodeGen.squareInteger

  public static void squareRootInteger() {
    // Generates code to square root integer value on top of evaluation stack
    emit(PVM.sqrt);
